...
const Footer = () => {
  return (
    <div>
      <Card className="bg-gray-900 rounded-none mt-36">
        <CardHeader
          floated={true}
          className="bg-blue-gray-100 shadow-2xl shadow-black mb-12 mx-5 px-10 py-10 lg:mx-28"
        >
          <div className="flex flex-row flex-wrap items-center justify-center gap-y-6 gap-x-1 text-center md:justify-between">
            <img src={logo2} alt="logo-ct" className="w-36" />
            <ul className="flex flex-wrap items-center gap-y-2 gap-x-8">
              <li className="flex-col gsp-y-2">
                <Typography
                  as="a"
                  href="#"
                  color="blue-gray"
