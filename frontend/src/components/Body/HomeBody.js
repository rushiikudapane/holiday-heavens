  ...
  return (
    <div className="flex flex-col items-center justify-center w-full">
      ...
      <div className="mb-8 w-11/12">
        <Tabs value="Camps" className="w-full">
          <TabsHeader className="shadow-xl bg-cyan-50">
      ...
      <div className="relative w-auto h-auto">
        ...
        <div>
          ...
          <Button className="absolute top-1/2 left-1/2 transform -translate-x-40 -translate-y-20 z-10">
            Call now
          </Button>
        </div>
        {/* ) : (
