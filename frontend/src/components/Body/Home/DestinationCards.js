...
const DestinationCards = () => {
  ...
  return (
    <div className="mb-8 w-11/12">
      <Tabs
        value="Camps"
        className="w-full bg-gray-200 rounded-xl shadow-inner border-t-4 border-cyan-900 flex flex-col justify-center items-center py-15"
      >
        <TabsHeader className="shadow-xl bg-cyan-50 w-full lg:w-96 mt-10">
        ...
        <TabsBody className="my-5 items-center lg:px-10">
          <div>
            {data.map(({ value, desc }) => (
              <TabPanel
                key={value}
                value={value}
                className="flex lg:justify-between flex-wrap items-center gap-3 justify-center"
              >
                <Link to="/card-details">
                  <Card className="w-80 max-w-[26rem] shadow-xl mt-16 hover:scale-105 transition ease-in-out delay-100 duration-300">
                    ...
                    <CardBody>
                      ...
                      <div className="group mt-8 inline-flex flex-wrap items-center gap-3">
                        ...
                        <Tooltip content="Fun activities">
                          <span className="cursor-pointer rounded-full border border-gray-900/5 bg-gray-900/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                ...
                <Card className="w-80 max-w-[26rem] shadow-xl mt-16">
                  <CardHeader floated={true} color="blue-gray">
                    <img
                      src="https://images.unsplash.com/photo-1499696010180-025ef6e1a8f9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
                      alt="ui/ux review check"
